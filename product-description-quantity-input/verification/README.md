...
2. Confirm `git -C /Users/jerell/Repos/dim rev-parse --short HEAD` matches the document footer `5d9cf0d`. If the source has moved, decide whether to update the source commit before recording results.
